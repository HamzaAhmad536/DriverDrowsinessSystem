      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions about our driver drowsiness detection system? 
            Want to collaborate or integrate our technology? We'd love to hear from you.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">hamzaahmad2003@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">+92 326 4140389 </p>
                  </div>
                </div>
            ...
            {/* <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl">
              ...
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Hamza Ahmad</p>
                    <p className="text-sm text-gray-600">Lead ML Engineer</p>
                    <p className="text-xs text-gray-500">Lahore, Pakistan</p>
                    <p className="text-xs text-gray-500">03264140389</p>
                  </div>
                </div>
              </div>
            </div> */}
